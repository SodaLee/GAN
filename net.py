...
def build_generator(ginputs):
	...
	with tf.name_scope('G_deconv3'):
		...
		params.append(f_deconv3)
		G_deconv3 = tf.concat([G_deconv3, G_conv3], axis=3)
		G_deconv3, f = conv_layer(G_deconv3, [3, 3, 128, 64], stride, padding='SAME')
	...
	with tf.name_scope('G_deconv2'):
		...
		params.append(f_deconv2)
		G_deconv2 = tf.concat([G_deconv2, G_conv2], axis=3)
		G_deconv2, f = conv_layer(G_deconv2, [3, 3, 64, 32], stride, padding='SAME')
